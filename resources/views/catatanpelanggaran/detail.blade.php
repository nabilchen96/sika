            ...
            <div class="col-lg-12">
                <div class="card mb-12">
                    <div class="card-header">
                        <a href="{{ url('catatanpelanggaran') }}" class="btn btn-sm btn-success"><i class="fas fa-arrow-left"></i> Kembali</a>
                        @if (auth::user()->role != 'taruna')
                        <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambahkamar"><i
                                class="fas fa-plus"></i> Tambah</a>
                        @endif

                        <a href="{{ url('catatanpelanggaranexportperson') }}/{{ $taruna->id_mahasiswa }}" class="btn btn-sm btn-success"><i class="fas fa-file-excel"></i> Export</a>
                                    ...
                                    <form id="formtambah" action="{{ url('simpan-catatanpelanggaran') }}" method="post"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="hukuman" rows="3" class="form-control"
                                                    required></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" width="100%" id="dataTable"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button {{ auth::user()->role == 'taruna' ? "disabled" : '' }} href="#"
                                    ...
                                    <td>
                                        <button {{ auth::user()->role == 'taruna' ? "disabled" : '' }}
