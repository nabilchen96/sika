            ...
            <div class="card mb-12">
                <div class="card-header">
                    @if (auth::user()->role == 'admin' || auth::user()->role == 'pusbangkar')
                        <a href="{{ url('tambah-tarunakamar') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i>
                            Tambah</a>
                    @endif

                    <a href="{{ url('tarunakamarexport') }}" class="btn btn-sm btn-success"><i
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            @if (auth::user()->role == 'admin' || auth::user()->role == 'pusbangkar')
                                return `<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus` +
                                    row.id_taruna_kamar + `"><i class="fas fa-trash"></i></button>
