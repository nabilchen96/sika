        ...
        <div class="container">
            ...
            <section class="features-overview" id="features-section" style="padding-top: 50px;">
                <div class="content-header">
                    ...
                    <ul class="nav nav-lt-tab mb-4" style="border: 0;" role="tablist">
                        <li class="nav-item">
                            <a href="{{ url('/pengumuman') }}" style="border-radius: 25px;"
                                class="btn btn-sm btn-{{ Request('filter') == '' ? 'info' : 'primary' }}">All</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/pengumuman') }}?filter=1" style="border-radius: 25px;"
                                class="btn btn-sm btn-{{ Request('filter') == '1' ? 'info' : 'primary' }}">Pendidikan</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/pengumuman') }}?filter=2" style="border-radius: 25px;"
                                class="btn btn-sm btn-{{ Request('filter') == '2' ? 'info' : 'primary' }}">Lowongan
                                Kerja</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/pengumuman') }}?filter=3" style="border-radius: 25px;"
                                class="btn btn-sm btn-{{ Request('filter') == '3' ? 'info' : 'primary' }}">Layanan</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/pengumuman') }}?filter=4" style="border-radius: 25px;"
            ...
            <footer class="border-top">
                <p class="text-center text-muted pt-4">Copyright © <?php echo date('Y'); ?> Subbag Aktar Politeknik Penerbangan
                    Palembang.
                    Developed by<a target="_blank" href="https://sahretech.com" target="_blank"
                        class="px-1">Mustechs</a>All rights reserved.</p>
            </footer>
        </div>
    </div>
@endsection
