        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-12">
                <div class="card-header">
                    <a href="{{ url('penilaiansoftskill') }}?id_mahasiswa={{ $taruna->id_mahasiswa }}&id_semester={{ Request('id_semester') }}"
                        class="btn btn-sm btn-success"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <form action="{{ url('updatepenilaiansoftskill') }}" method="POST">
                            ...
                            <table class="table table-bordered table-striped" width="100%" id="dataTable" cellspacing="0">
                                ...
                                <tbody>
                                    @php
                                        $groupedSoal = $soal->groupBy('jenis_softskill');
                                        $no = 1;
                                    @endphp

                                    @foreach ($groupedSoal as $jenis_softskill => $items)
                                        <tr>
                                            <td colspan="3"><strong>
                                                    <h4>{{ $jenis_softskill }}</h4>
                                                </strong></td>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select name="nilai[]" class="form-control">
                                                        <option {{ @$nilai === null ? 'selected' : '' }} value="">
                                                            ----
                                                        </option>
                                                        <option {{ @$nilai->nilai == 100 ? 'selected' : '' }} value=100>
                                                            Ya
                                                        </option>
                                                        <option {{ @$nilai->nilai === 0.0 ? 'selected' : '' }} value=0>
                                                            Tidak
                                                        </option>
                                                    </select>
