    ...
    <div class="col-lg-12">
        ...
        <div class="card mb-12">
            <div class="card-header">
                <a href="{{url('tarunapengasuh')}}" class="btn btn-sm btn-success"><i class="fas fa-arrow-left"></i>
                    Kembali</a>
            </div>
            <form action="{{ url('simpan-tarunapengasuh') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nama Pengasuh</label>
                        <div class="col-sm-3">
                            <select name="id_pengasuh" class="form-control">
